# Praktikum Pembelajaran Mesin - JTI 2026

Organisasi ini dipakai untuk praktikum, tugas praktikum, dan PBL mata kuliah **Pembelajaran Mesin (RTI235004)**.

- Modul: [JTI - Modul Praktikum Pembelajaran Mesin](https://polinema.gitbook.io/jti-modul-praktikum-pembelajaran-mesin-2025-2026)
- Repo praktikum kamu: `praktikum-<NIM>` (dibuat otomatis, cek email undangan dari GitHub)
- Repo PBL kelompok kamu: `pbl-<kode-kelompok>`
